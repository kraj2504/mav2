...
//			generateBillPageObject.enterAddress(sAddress, sArea, sCity, sState, sCountry, sPincode);
			...
			Assert.assertEquals(sampleOutsource.isPatientDisplayed(sFirstName),"TRUE","***Patient details not displayed in outsourced list***");
			Assert.assertEquals(sampleOutsource.isInvestigationDisplayed(sFirstName, sServiceName),"TRUE","***Investigation name not showing in outsourced list***");
			sampleOutsource.viewNonOutsourcedTest();
			Assert.assertEquals(sampleOutsource.isPatientDisplayed(sFirstName),"FALSE","***Patient details displayed in outsourced list***");
