...
public class S94_CheckDoctorPayOffWhenDiscountTypeIsDoctorApprovedByDoctorAndDiscountInPercentage
{
	...
	@Test(priority = 1)
	public void s94_CheckDoctorPayOffWhenDiscountTypeIsDoctorApprovedByDoctorAndDiscountInPercentage() throws Exception
	{
		try 
		{
			...
			MasterControlObject.gotoPage(Constant.PAGE_DOCTOR_PAYOFF);
...
//			generateBillPageObject.selectReferralName(sReferralName);
			...
			generateBillPageObject.enterBillDiscount(sBillDiscountValue);
