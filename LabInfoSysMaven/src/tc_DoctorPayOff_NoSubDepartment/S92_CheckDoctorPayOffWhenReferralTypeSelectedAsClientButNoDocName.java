...
public class S92_CheckDoctorPayOffWhenReferralTypeSelectedAsClientButNoDocName
{
	...
	@Test(priority = 1)
	public void s92_CheckDoctorPayOffWhenReferralTypeSelectedAsClientButNoDocName() throws Exception
	{
		try 
		{
