...
public class S78_DoctorPayoffAllowed_Value0_Range0_SubValue0_SubRange0_InvestFlatpay_value10
{
	...
	@Test(priority = 1)
	public void s78_DoctorPayoffAllowed_Value0_Range0_SubValue0_SubRange0_InvestFlatpay_value10() throws Exception
	{
		...
		try 
		{
			...
			sPayoutValue = doctorPayoff.enterValueForInvestigationForFlat(sInvestigationName, sPayoutValue);
