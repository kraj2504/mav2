...
public class S101_CheckDoctorPayOffCalculatedWhenDiscountTypeStaffAndApprovedByOtherUser
{
	...
	@Test(priority = 1)
	public void s101_CheckDoctorPayOffCalculatedWhenDiscountTypeStaffAndApprovedByOtherUser() throws Exception
	{
		try 
		{
