...
public class S98_DoctorPayOffCalculatedWhenDiscountTypePatientAndApprovedByDoctor
{
	...
	@Test(priority = 1)
	public void s98_DoctorPayOffCalculatedWhenDiscountTypePatientAndApprovedByDoctor() throws Exception
	{
		try 
		{
