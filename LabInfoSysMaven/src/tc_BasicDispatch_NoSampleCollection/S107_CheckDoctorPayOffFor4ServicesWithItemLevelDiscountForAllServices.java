...
public class S107_CheckDoctorPayOffFor4ServicesWithItemLevelDiscountForAllServices
{
	...
	@Test(priority = 1)
	public void s107_CheckDoctorPayOffFor4ServicesWithItemLevelDiscountForAllServices() throws Exception
	{
		try 
		{
...
//			generateBillPageObject.selectReferralName(sReferralName);
			...
			generateBillPageObject.EnterItemDiscount(2,sItemDiscountType2,sItemDiscountValue2);
			
			generateBillPageObject.EnterServiceName(3,sServiceName3);
			generateBillPageObject.EnterItemDiscount(3,sItemDiscountType3,sItemDiscountValue3);
			
			generateBillPageObject.EnterServiceName(4,sServiceName4);
			generateBillPageObject.EnterItemDiscount(4,sItemDiscountType4,sItemDiscountValue4);
