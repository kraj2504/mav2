...
public class S106_CheckDoctorPayOffWhenDiscountTypeIsDoctorApprovedByDoctorAndDiscountInPercentage
{
	...
	@Test(priority = 1)
	public void s106_CheckDoctorPayOffWhenDiscountTypeIsDoctorApprovedByDoctorAndDiscountInPercentage() throws Exception
	{
		try 
		{
...
//			generateBillPageObject.selectReferralName(sReferralName);
			...
			doctorPayoffReport.verifyPayOffAmount(sBillDiscountValue);
