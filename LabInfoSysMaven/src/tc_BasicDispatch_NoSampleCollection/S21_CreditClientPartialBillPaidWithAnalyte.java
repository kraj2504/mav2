...
public class S21_CreditClientPartialBillPaidWithAnalyte
{
	...
	@Test(priority = 1)
	public void s21_ClientPartialBillPaidWithAnalyte() throws Exception
	{
		...
		try 
		{
			...
			//Approve result in Manage Approval
