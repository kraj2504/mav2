...
public class S69_DoctorPayoffAllowed_Value0_Range20_SubValue20_SubRange20
{
	...
	@Test(priority = 1)
	public void s69_DoctorPayoffAllowed_Value0_Range20_SubValue20_SubRange20() throws Exception
	{
...
//			Assert.assertEquals(MasterControlObject.getAlertMsg(), "Updated Successfully", "*** Doctor payoff --> Alert not shown as expected ***");
			...
			doctorPayoff.searchDoctor(sDoctorName);
			doctorPayoff.verifyRangeForDept(sSubDepartmentName, sRange);
