...
public class S99_CheckDoctorPayOffCalculatedWhenDiscountTypePatientAndApprovedByOtherUser
{
	...
	@Test(priority = 1)
	public void s99_CheckDoctorPayOffCalculatedWhenDiscountTypePatientAndApprovedByOtherUser() throws Exception
	{
		try 
		{
