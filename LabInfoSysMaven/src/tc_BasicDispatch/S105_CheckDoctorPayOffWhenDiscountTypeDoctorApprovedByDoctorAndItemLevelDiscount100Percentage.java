...
public class S105_CheckDoctorPayOffWhenDiscountTypeDoctorApprovedByDoctorAndItemLevelDiscount100Percentage
{
	...
	@Test(priority = 1)
	public void s105_CheckDoctorPayOffWhenDiscountTypeDoctorApprovedByDoctorAndItemLevelDiscount100Percentage() throws Exception
	{
		try 
		{
...
//			generateBillPageObject.selectReferralName(sReferralName);
			...
			doctorPayoffReport.verifyPayOffAmount(sItemDiscountValue);
