...
public class VerifyingTransactionItemPerDiscounts
{
	...
	public void generateBillingWithNoDues() throws Exception
	{
		...
		try 
		{
			...
			Thread.sleep(2000);
			generateBillPageObject1.selectItemDiscountType(1,"Percentage");
			generateBillPageObject1.selectItemDiscountType(2,"Percentage");
			generateBillPageObject1.selectItemDiscountType(3,"Percentage");
			Thread.sleep(2000);
			generateBillPageObject1.EnterItemDiscountValue(1,"10.00");
			generateBillPageObject1.EnterItemDiscountValue(2,"10.00");
			generateBillPageObject1.EnterItemDiscountValue(3,"10.00");
			...
			Thread.sleep(2000);
			String dis = generateBillPageObject1.calculateItemDiscountInPercentage();
