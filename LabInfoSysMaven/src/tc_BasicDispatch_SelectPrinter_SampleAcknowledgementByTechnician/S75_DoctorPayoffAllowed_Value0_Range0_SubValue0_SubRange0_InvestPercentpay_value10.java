...
public class S75_DoctorPayoffAllowed_Value0_Range0_SubValue0_SubRange0_InvestPercentpay_value10
{
	...
	@Test(priority = 1)
	public void s75_DoctorPayoffAllowed_Value0_Range0_SubValue0_SubRange0_InvestPercentpay_value10() throws Exception
	{
		...
		try 
		{
			...
			doctorPayoff.searchDoctor(sDoctorName);
			doctorPayoff.verifyRangeForDept(sDepartmentName, sDepRange);
			doctorPayoff.verifyValueForDept(sDepartmentName, sDepValue);
...
//			generateBillPageObject.selectReferralName(sReferralName);
			...
			doctorPayoffReport.verifyPayOffAmount(sPayoutValue);
