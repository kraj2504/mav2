...
public class S16_CreditClientPartialBillPaidWithPackage
{
	...
	@Test(priority = 1)
	public void s16_ClientPartialBillPaidWithPackage() throws Exception
	{
		...
		try 
		{
			...
			Assert.assertEquals(patientListPageObjects.getPatientBillDue(),"0.00","***Due not updated as expected***");
...
/*			MasterControlObject.gotoPage("Recall");
