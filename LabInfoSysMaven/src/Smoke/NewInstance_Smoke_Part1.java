...
public class NewInstance_Smoke_Part1
{
...
//		String sReferralType = ExcelUtils.getCellData(iTestCaseRow, Constant.col_ReferralType);
		...
		try
		{
			...
			softassert.assertTrue(generateBillPageObject.doctorNameEnableStatus(),"***Doctor name not enabled***");
			
			generateBillPageObject.selectDoctorName(sDoctorName);
			softassert.assertTrue(generateBillPageObject.getDoctorName().trim().equals(sDoctorName),"***Actual and expected doctor names not equal***");
	...
	public void mandatoryFieldsVerificationInRegistration() throws Exception
	{
		...
		try 
		{
			...
			softassert.assertEquals(msg4,"Please Enter First Name","***Alert not displayed as expected***");
			
			generateBillPageObject.EnterFirstName(sFirstName);
			generateBillPageObject.ClickGenerateBill();
			String msg5 = MasterControlObject.getAlertMsg();
			MasterControlObject.acceptAlert();
			softassert.assertEquals(msg5,"Please Select Gender","***Alert not displayed as expected***");
			
			generateBillPageObject.selectGender(sGender);
			generateBillPageObject.ClickGenerateBill();
			String msg6 = MasterControlObject.getAlertMsg();
			MasterControlObject.acceptAlert();
			softassert.assertEquals(msg6,"Please Enter Age","***Alert not displayed as expected***");
			
			generateBillPageObject.enterAge(sAge);
			generateBillPageObject.ClickGenerateBill();
//			String msg7 = MasterControlObject.getAlertMsg();
//			MasterControlObject.acceptAlert();
//			softassert.assertEquals(msg7,"Please Enter Mobile No","***Alert not displayed as expected***");
...
//			generateBillPageObject.ClickGenerateBill();
			...
			MasterControlObject.acceptAlert();
			softassert.assertEquals(msg8,"Please Enter Order Details","***Alert not displayed as expected***");
			...
			MasterControlObject.acceptAlert();
			softassert.assertEquals(msg1,"Please Enter Amount Or %","***Alert not displayed as expected***");
			
			generateBillPageObject.selectBillDiscountTypeAs(sBillDiscountTypeAs);
			generateBillPageObject.enterBillDiscount("0.00");
			
			generateBillPageObject.ClickGenerateBill();
			String msg2 = MasterControlObject.getAlertMsg();
			MasterControlObject.acceptAlert();
			softassert.assertEquals(msg2,"Please Select Approved By","***Alert not displayed as expected***");
			
			generateBillPageObject.selectApprovedBy(sApprovedBy);
			generateBillPageObject.ClickGenerateBill();
			String msg3 = MasterControlObject.getAlertMsg();
			MasterControlObject.acceptAlert();
			softassert.assertEquals(msg3,"Please Enter Remarks","***Alert not displayed as expected***");
			softassert.assertAll();
		}	
	...
	{	
		...
		try 
		{
			...
			MasterControlObject.acceptAlert();
			softassert.assertEquals(msg,"Saved successfully","***Registration --> Alert msg not displayed as expected.***");
			...
			softassert.assertEquals(sTitle,rTitle,"***Title not updated as expected***");
			softassert.assertTrue(sFirstName.equalsIgnoreCase(rFirstName),"***FirstName not updated as expected***");
			softassert.assertEquals(sGender,rGender,"***Gender not updated as expected***");
			
			softassert.assertEquals(rAge,sAge,"***Age not updated as expected***");
			softassert.assertEquals(rAgeType,sAgeType,"***AgeType not updated as expected***");
			softassert.assertEquals(rMobileNo,sMobileNo,"***MobileNo not updated as expected***");
			softassert.assertTrue(rPatientBillGross.startsWith(sActualgross),"*** PatientBill Gross not updated as expected ***");
			softassert.assertEquals(rPatientBillDiscount,actualdiscount,"*** PatientBill discount not updated as expected ***");
			softassert.assertEquals(rPatientBillNet,actualnetamount,"***PatientBill Net not updated as expected***");
			softassert.assertTrue(rPatientBillCollected.startsWith(paiddueamount),"***PatientBillCollected not updated as expected***");
			softassert.assertEquals(rPatientBillDue,currentdueamount,"*** PatientBill due not updated as expected ***");
			softassert.assertEquals(rPatientBillRefferedBy,sRefferedType,"***PatientBillRefferedBy not updated as expected***");
			softassert.assertTrue(rServiceName.equalsIgnoreCase(sServiceName),"***ServiceName not updated as expected***");
			
			softassert.assertTrue(patientListPageObject.getStatus().equalsIgnoreCase("Registered"),"***Status not updated as expected***");
			softassert.assertTrue(landline.equalsIgnoreCase(sLandline),"***Landline not updated as expected***");
			softassert.assertTrue(marital.equalsIgnoreCase(sMaritalStatus),"***MaritalStatus not updated as expected***");
			softassert.assertTrue(UID_type.equalsIgnoreCase(sUIDType),"***UIDType not updated as expected***");
			softassert.assertTrue(UID_no.equalsIgnoreCase(sUIDNo),"***UIDNo not updated as expected***");
			softassert.assertTrue(externalid.equalsIgnoreCase(sExternalID),"***ExternalID not updated as expected***");
			softassert.assertTrue(address.equalsIgnoreCase(sAddress),"***Address not updated as expected***");
			softassert.assertTrue(area.equalsIgnoreCase(sArea),"***Area not updated as expected***");
			softassert.assertTrue(city.equalsIgnoreCase(sCity),"***City not updated as expected***");
			softassert.assertTrue(state.equalsIgnoreCase(sState),"***State not updated as expected***");
			softassert.assertTrue(country.equalsIgnoreCase(sCountry),"***Country not updated as expected***");
			softassert.assertTrue(pincode.equalsIgnoreCase(sPincode),"***Pincode not updated as expected***");
			softassert.assertAll();
		}
