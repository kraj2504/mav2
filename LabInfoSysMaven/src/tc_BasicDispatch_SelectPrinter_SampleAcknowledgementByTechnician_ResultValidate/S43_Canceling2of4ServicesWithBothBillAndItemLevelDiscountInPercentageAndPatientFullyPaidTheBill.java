...
public class S43_Canceling2of4ServicesWithBothBillAndItemLevelDiscountInPercentageAndPatientFullyPaidTheBill
{
	...
	public void beforeMethod() throws Exception
	{
     ...
     // This scenario is Canceling any 2 of 4 services, with both bill and item level discount in percentage and patient fully paid the bill
	@Test(priority = 1)
	public void s43_Canceling2of4ServicesWithBothBillAndItemLevelDiscountInPercentageAndPatientFullyPaidTheBill() throws Exception
	{
		...
		try
		{
			...
			patientListPageObjects.verifyingStatus("Registered");
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			System.out.println("sServiceName1:"+sServiceName1);
			System.out.println("sServiceName2:"+sServiceName2);
			System.out.println("sServiceName3:"+sServiceName3);
			System.out.println("sServiceName4:"+sServiceName4);
			...
			patientListPageObjects.selectPatientBill();
			patientListPageObjects.verifyingStatusBarCode("Cancelled", sServiceName1, sServiceName2);
			patientListPageObjects.verifyingStatusBarCode("Result Validated", sServiceName3, sServiceName4);
