...
public class S46_Canceling2of4ServicesWithBothBillAndItemLevelDiscountInAmountAndPatientFullyPaidTheBill
{
	...
	public void beforeMethod() throws Exception
	{
     ...
     // This scenario is for Canceling any 2 of 4 services, with both bill and item level discount in amount and patient fully paid the bill
	@Test(priority = 1)
	public void s46_Canceling2of4ServicesWithBothBillAndItemLevelDiscountInAmountAndPatientFullyPaidTheBill() throws Exception
	{
		...
		
		{
			...
			patientListPageObjects.verifyingStatus(sServiceName1, sServiceName2,"Cancelled");
			patientListPageObjects.verifyingStatus(sServiceName3, sServiceName4,"Sample Received");
			...
			patientListPageObjects.selectPatientBill();
			patientListPageObjects.verifyingStatus(sServiceName1, sServiceName2,"Cancelled");
			patientListPageObjects.verifyingStatus(sServiceName3, sServiceName4,"Result Validated");
