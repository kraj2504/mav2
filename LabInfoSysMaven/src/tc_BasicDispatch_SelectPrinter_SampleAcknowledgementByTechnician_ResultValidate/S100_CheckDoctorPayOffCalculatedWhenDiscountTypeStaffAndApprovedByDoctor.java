...
public class S100_CheckDoctorPayOffCalculatedWhenDiscountTypeStaffAndApprovedByDoctor
{
	...
	@Test(priority = 1)
	public void s100_CheckDoctorPayOffCalculatedWhenDiscountTypeStaffAndApprovedByDoctor() throws Exception
	{
		try 
		{
