...
public class S103_CheckDoctorPayOffWhenDiscountTypeDoctorApprovedByDoctorAndItemLevelDiscountInPercentage
{
	...
	@Test(priority = 1)
	public void s103_CheckDoctorPayOffWhenDiscountTypeDoctorApprovedByDoctorAndItemLevelDiscountInPercentage() throws Exception
	{
		try 
		{
...
//			generateBillPageObject.selectReferralName(sReferralName);
			...
			generateBillPageObject.EnterItemDiscount(1, sItemDiscountType, sItemDiscountValue);
