...
public class ManageApproval_VerifyStatusAfterResultApproval
{
	...
	@Test(priority = 1)
	public void verifyStatusAfterResultApproval() throws Exception
	{
		...
		{		 
			...
			Assert.assertEquals(patientListPageObject.getStatus(),"Approved");
		}
	...
	public void updateResult(ITestResult result) throws Exception
	{
		if(result.getStatus() == ITestResult.SUCCESS)
		{
			...
			Log.info("Status showing as 'Approved' ==> Test Passed");
		}
		else if(result.getStatus() == ITestResult.FAILURE)
		{
			ExcelUtils.setCellData("Fail", iTestCaseRow, Constant.col_Result);
			Log.info("Status not showing as 'Approved' ==> Test Failed");
			Utils.takeScreenshot(driver, sTestCaseName);
		}
