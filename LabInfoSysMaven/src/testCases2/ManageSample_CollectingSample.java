...
public class ManageSample_CollectingSample
{
	...
	@Test(priority = 1)
	public void sampleCollection() throws Exception
	{
	...
	public void updateResult(ITestResult result) throws Exception
	{
		if(result.getStatus() == ITestResult.SUCCESS)
		{
			...
			Log.info("Can able to collect Sample, Bar code generated and Status changed to 'Sample Collected' ==> Test Passed");
		}
		else if(result.getStatus() == ITestResult.FAILURE)
		{
			ExcelUtils.setCellData("Fail", iTestCaseRow, Constant.col_Result);
			Log.info("Can not able to collect Sample or Bar code not generated or Status not changed to 'Sample Collected' ==> Test Failed");
			Utils.takeScreenshot(driver, sTestCaseName);
		}
