...
public class ManageSample_VerifyRegisteredPatientDetailsinManageSamplesList
{
	...
	@Test(priority = 1)
	public void verifyRegisteredPatientDetailsinManageSamplesList() throws Exception
	{
	...
	public void updateResult(ITestResult result) throws Exception
	{
		if(result.getStatus() == ITestResult.SUCCESS)
		{
			...
			Log.info("Added Patient details showing in Manage Sample ==> Test Passed");
		}

		else if(result.getStatus() == ITestResult.FAILURE)
		{
			ExcelUtils.setCellData("Fail", iTestCaseRow, Constant.col_Result);
			Log.info("Added Patient details not showing in Manage Sample ==> Test Failed");
			Utils.takeScreenshot(driver, sTestCaseName);
		}
