...
public class ManageDispatch_RecordinShowEMailedReportOfDispatchAfterEMail
{
	...
	@Test(priority = 1)
	public void recordinShowEMailedReportOfDispatchAfterEMail() throws Exception
	{
	...
	public void updateResult(ITestResult result) throws Exception
	{
		if(result.getStatus() == ITestResult.SUCCESS)
		{
			...
			Log.info("EMailed record showing in ShowPrintedReport ==> Test Passed");
		}
		else if(result.getStatus() == ITestResult.FAILURE)
		{
			ExcelUtils.setCellData("Fail", iTestCaseRow, Constant.col_Result);
			Log.info("EMailed record showing in ShowPrintedReport ==> Test Failed");
			Utils.takeScreenshot(driver, sTestCaseName);
		}
