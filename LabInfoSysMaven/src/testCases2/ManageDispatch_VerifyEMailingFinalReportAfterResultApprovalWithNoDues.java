...
public class ManageDispatch_VerifyEMailingFinalReportAfterResultApprovalWithNoDues
{
	...
	@Test(priority = 1)
	public void verifyEMailingFinalReportAfterResultApprovalWithNoDues() throws Exception
	{
		...
		{		 
			...
			Assert.assertEquals(msg,"Dispatch List Emailed");
		}
	...
	public void updateResult(ITestResult result) throws Exception
	{
		if(result.getStatus() == ITestResult.SUCCESS)
		{
			...
			Log.info("Record Emailed ==> Test Passed");
		}
		else if(result.getStatus() == ITestResult.FAILURE)
		{
			ExcelUtils.setCellData("Fail", iTestCaseRow, Constant.col_Result);
			Log.info("Record not Emailed ==> Test Failed");
			Utils.takeScreenshot(driver, sTestCaseName);
		}
