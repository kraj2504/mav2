...
public class Reg_MandatoryOptionForApprovedByAfterSelectDiscountType
{
	...
	@Test(priority = 1)
	public void mandatoryOptionForApprovedByAfterSelectDiscountType() throws Exception
	{
	...
	public void updateResult(ITestResult result) throws Exception
	{
		if(result.getStatus() == ITestResult.SUCCESS)
		{
			...
			Log.info("Alert shown as 'Please Select Approved By' ==> Test Passed");
		}
		else if(result.getStatus() == ITestResult.FAILURE)
		{
			ExcelUtils.setCellData("Fail", iTestCaseRow, Constant.col_Result);
			Log.info("Alert not shown as 'Please Select Approved By' ==> Test Failed");
			Utils.takeScreenshot(driver, sTestCaseName);
		}
