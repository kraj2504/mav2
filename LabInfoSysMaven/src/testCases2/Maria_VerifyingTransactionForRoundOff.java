...
public class VerifyingTransactionForRoundOff
{
	...
	public void generateBillingWithNoDues() throws Exception
	{
		...
		try 
		{
			...
			generateBillPageObject1.EnterItemDiscountValue(1,"1.5");		
			...
			Assert.assertEquals(generateBillPageObject1.calculateRoundOff(),calRoundOff,"***RoundOFf Amount not updated as expected***");
			
			//String roundOff = generateBillPageObject1.calculateRoundOff();
			//Assert.assertEquals("***RoundOFf Amount not updated as expected***",calRoundOff.startsWith(roundOff));
