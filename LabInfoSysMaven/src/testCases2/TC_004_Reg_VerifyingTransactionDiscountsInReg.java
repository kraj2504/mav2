...
public class VerifyingTransactionDiscountsInReg
{
	...
	public void generateBillingWithNoDues() throws Exception
	{
		...
		try 
		{
			...
			Thread.sleep(2000);
			//generateBillPageObject1.selectItemDiscountType(1,"Amount");
			//Thread.sleep(2000);
			//generateBillPageObject1.EnterItemDiscountValue(1,"5.00");
			
			generateBillPageObject1.EnterItemDiscount(1,"Amount");
			//generateBillPageObject1.EnterItemDiscount(1,"Amount","10");
		...
		Thread.sleep(2000);
		String CalDis=generateBillPageObject1.getDiscountValueforOneService();
		System.out.println("CalDis: "+ CalDis);
		String Discount=generateBillPageObject1.getDiscountAmount();
		Assert.assertEquals(Discount, CalDis);
	//	Assert.assertEquals("***Discount Amount not updated as expected***",CalDis.startsWith(Discount));
