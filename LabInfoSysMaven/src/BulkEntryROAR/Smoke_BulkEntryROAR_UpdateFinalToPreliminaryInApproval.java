...
public class Smoke_BulkEntryROAR_UpdateFinalToPreliminaryInApproval
{
	...
	@Test(priority = 1)
	public void smoke_BulkEntryROAR_PreliminaryAndFinal_UptoDispatch_Growth() throws Exception
	{
		...
		try 
		{
			...
			ROARApproval.verifyAnalyte(sServiceName);
			ROARApproval.verifySampleType(sSampleType);
			ROARApproval.selectCultureReport("Preliminary");
			ROARApproval.selectResultType("Growth");
			ROARApproval.enterColonyCount("140");
			ROARApproval.selectIsolatedOrganism1("Acinetobacter species");
			...
			bulkEntryROAR.selectCultureReport("Final");
			bulkEntryROAR.selectResultType("Growth");
			bulkEntryROAR.enterColonyCount("150");
			bulkEntryROAR.selectIsolatedOrganism1("Acinetobacter species");
			bulkEntryROAR.selectAntibioticForOrganism1("Resistant");
			bulkEntryROAR.clickSave();
			Assert.assertEquals(MasterControlObject.getAlertMsg(),"Saved Successfully","***Alert not displayed as expected after entering results***");
