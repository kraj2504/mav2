...
public class Smoke_BulkEntryROAR_PreliminaryAndFinal_UptoDispatch_NoGrowth
{
	...
	@Test(priority = 1)
	public void smoke_BulkEntryROAR_PreliminaryAndFinal_UptoDispatch_NoGrowth() throws Exception
	{
		...
		try 
		{
			...
			bulkEntryROAR.selectResultType("No Growth");
