...
public class Smoke_BulkEntryROAR_PreliminaryAndFinal_UptoDispatch_Growth_TwoAnalyteFlow
{
	...
	@Test(priority = 1)
	public void smoke_BulkEntryROAR_PreliminaryAndFinal_UptoDispatch_Growth_TwoAnalyteFlow() throws Exception
	{
		...
		try 
		{
			...
			//Sample scanner acknowledgement
			...
			//Enter Preliminary Bulk Entry ROAR for analyte1
			MasterControlObject.gotoPage("BulkEntry ROAR");
			bulkEntryROAR.searchRecord(sFirstName);
			bulkEntryROAR.selectAnalyte(sServiceName1);
			bulkEntryROAR.verifyAnalyte(sServiceName1);
			...
			Assert.assertEquals(MasterControlObject.getAlertMsg(),"Saved Successfully","***Alert not displayed as expected after entering results***");
			MasterControlObject.acceptAlert();
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Preliminary Result Entered", sServiceName1);
			...
			Assert.assertEquals(MasterControlObject.getAlertMsg(),"Saved Successfully","***Alert not displayed as expected after approving results***");
			MasterControlObject.acceptAlert();
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Preliminary Approved", sServiceName1);
			System.out.println(3);
			//Enter Final Bulk Entry ROAR for analyte1
			MasterControlObject.changeRole(Constant.TECHNICIAN);
			MasterControlObject.gotoPage("BulkEntry ROAR");
			bulkEntryROAR.searchRecord(sFirstName);
			bulkEntryROAR.selectAnalyte(sServiceName1);
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Final Result Entered", sServiceName1);
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Final Approved", sServiceName1);
			System.out.println(5);
			//Enter Preliminary Bulk Entry ROAR for analyte2
			MasterControlObject.changeRole(Constant.TECHNICIAN);
			MasterControlObject.gotoPage("BulkEntry ROAR");
			bulkEntryROAR.searchRecord(sFirstName);
			bulkEntryROAR.selectAnalyte(sServiceName2);
			bulkEntryROAR.verifyAnalyte(sServiceName2);
			bulkEntryROAR.verifySampleType(sSampleType);
			bulkEntryROAR.selectCultureReport("Preliminary");
			bulkEntryROAR.selectResultType("Growth");
			bulkEntryROAR.enterColonyCount("140");
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Preliminary Result Entered", sServiceName2);
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Preliminary Approved", sServiceName2);
			System.out.println(7);
			//Enter Final Bulk Entry ROAR for analyte2
			MasterControlObject.changeRole(Constant.TECHNICIAN);
			MasterControlObject.gotoPage("BulkEntry ROAR");
			bulkEntryROAR.searchRecord(sFirstName);
			bulkEntryROAR.selectAnalyte(sServiceName2);
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Final Result Entered", sServiceName2);
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Final Approved", sServiceName2);
