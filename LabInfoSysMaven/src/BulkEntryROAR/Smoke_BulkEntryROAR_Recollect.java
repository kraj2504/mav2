...
public class Smoke_BulkEntryROAR_Recollect
{
	...
	public void smoke_BulkEntryROAR_PreliminaryAndFinal_UptoDispatch_Growth() throws Exception
	{
		...
		try 
		{
			...
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatus("Recollect");
			...
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Sample Collected");
			List<String> barcodes1 = patientListPageObjects.getAllBarCode();

			//Sample scanner acknowledgement
			MasterControlObject.changeRole(Constant.TECHNICIAN);
			MasterControlObject.gotoPage("Sample Scanner Ack");
			sampleScannerAck.AcknowledgeAllSamples(barcodes1);
			MasterControlObject.gotoPage("Patient List");
			patientListPageObjects.searchRecord(sFirstName);
			patientListPageObjects.verifyingStatusBarCode("Sample Received");
