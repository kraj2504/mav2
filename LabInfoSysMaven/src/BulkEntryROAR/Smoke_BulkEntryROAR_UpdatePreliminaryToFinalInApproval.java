...
public class Smoke_BulkEntryROAR_UpdatePreliminaryToFinalInApproval
{
	...
	public void smoke_BulkEntryROAR_PreliminaryAndFinal_UptoDispatch_Growth() throws Exception
	{
		...
		try 
		{
			...
			ROARApproval.selectCultureReport("Final");
			ROARApproval.selectAntibioticForOrganism1("Resistant");
